...
/*private ArrayList<Item> itemsInRoom;-list of items in room, a room can have multiple items depending on numItemsAllowedInRoom
	private ArrayList<Obstacle> obstaclesInRoom;-list of obstacles in room, a room can have multiple items depending on numObstalcesAllowedInRoom
	private Random rand;
	private boolean isEntrance; -return true if room is an entrance
	private boolean isExit; - returns true if room is an exit
	private boolean isEmpty; -returns true if room is empty
	private boolean containsPillarOfOO; -returns true if the rooms contains an oo pillar
	private String[] doors; -gives the list of doors in the room
	private Monster enemy; -holds the enemy in the room if present
	private int numItemsAllowedInRoom; -num items allowed in a room, set when room constructor is called
	private int numObstaclesAllowedInRoom;-num obstacles allowed in a room, set when room constructor is called
	private final int chance; -chance that a monster, obstacle, or item will be generated in the room
	private ItemFactory itemFactory;  -holds the item factory
	private MonsterFactory monsterFactory; -holds the mosnter factor
	private ObstacleFactory obstacleFactory; -holds the obstacle factory
	private PillarsOfOO pillar; -holds the OO pillar if there is one
	private String room2DRepresentation; -holds the 2d visual of the room
	private int numObstacleChoices; -holds the number of obstacles choices to be passsed to factory object
	private int numItemChoices;-holds the number of item choices to be passsed to factory object
	private int numMonsterChoices;-holds the number of monster choices to be passsed to factory object
	private Room2DDisplay room2dDisplay; -holds the 2d representation of the room
 * 
 */
public abstract class Room{
	...
	private boolean containsPillarOfOO;
	private String[] doors;
	private Monster enemy;
	private int numItemsAllowedInRoom;
	private int numObstaclesAllowedInRoom;
	...
	private int numObstacleChoices;
	private int numItemChoices;
	private int numMonsterChoices;
