...
//dungeon class that is responsible for holding the rooms and setting them up based on their location
public class Dungeon {
	...
	private int[] abstractionPillarLocation;
	private int[] polymorphismPillarLocation;
	private int[] encapsulationPillarLocation;
	private int[] inheritancePillarLocation;
	private Random rand;
	private int roomGenerationChance;
	private int numItemsAllowedInRoom;
	private int numObstaclesAllowedInRoom;
	private ArrayList<int[]> uniqueRoomNumbers;
	private ArrayList<int[]> pillarsOfOOLocationList;
